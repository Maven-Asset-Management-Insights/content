...
<div class="glossary-shell">
  ...
  <div class="glossary" id="glossary-list">
    ...
    <div class="glossary-term" data-category="reliability strategy">
      ...
      <p>Asset Criticality is a ranking of assets based on risk factors such as safety, production, and cost, helping prioritize maintenance, reliability efforts, and data quality focus.</p>
    </div>
    ...
    <div class="glossary-term" data-category="analytics reliability">
      ...
      <p>Asset Health Index is a combined score representing asset condition using performance, failure, and condition data, helping teams quickly assess overall asset health and prioritize action.</p>
    </div>
    ...
    <div class="glossary-term" data-category="data-quality reliability">
      ...
      <p>Failure Data Quality is the accuracy and consistency of failure-related data, helping enable meaningful root cause analysis and reliability improvement.</p>
    </div>
    ...
    <div class="glossary-term" data-category="reliability">
      ...
      <p>Failure Mode is the specific way an asset fails, helping teams understand failure patterns and improve maintenance strategies.</p>
    </div>
    ...
    <div class="glossary-term" data-category="maintenance reliability">
      ...
      <p>Planned vs. Unplanned Work compares prepared maintenance with reactive work, helping teams understand how effectively work is being managed.</p>
    </div>
    ...
    <div class="glossary-term" data-category="reliability strategy">
      ...
      <p>Reliability Strategy defines the maintenance approach used to manage asset risk and performance, helping determine what work is done and how often.</p>
    </div>
